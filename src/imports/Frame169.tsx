...
export default function Frame169() {
  return (
    <div className="relative size-full bg-transparent">
      <p className="absolute font-['Lateef:SemiBold',sans-serif] leading-[normal] left-0 not-italic text-[#9333EA] text-[49px] top-[37px]" dir="auto">
        Mobideo — Field Operations Platform
      </p>
      <p className="absolute font-['Montserrat:Regular',sans-serif] font-normal leading-[normal] left-0 text-[#626b7e] text-[18px] text-nowrap top-[101px] whitespace-pre" dir="auto">
        A digital platform for field operations and task management
      </p>
      <p className="absolute font-['Lateef:SemiBold',sans-serif] leading-[normal] left-0 not-italic text-[#9333EA] text-[42px] text-nowrap top-[195px] whitespace-pre" dir="auto">
        Project Overview
      </p>
      <p className="absolute font-['Lateef:SemiBold',sans-serif] leading-[normal] left-0 not-italic text-[#9333EA] text-[42px] text-nowrap top-[510px] whitespace-pre" dir="auto">
        The Challenge
      </p>
      <Frame3 />
